...
<div class="card">
    <div class="card-header">
        <?php echo e(trans('global.create'), false); ?> <?php echo e(trans('cruds.schoolClass.title_singular'), false); ?>

    </div>

    <div class="card-body">
        <form method="POST" action="<?php echo e(route("admin.school-classes.store"), false); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div class="row">
                <div class="col-4">
            ...
            <div class="form-group">
                ...
                <select name='campus' class="custom-select" required>
                    <?php $__currentLoopData = $campuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $campus): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($campus, false); ?>"><?php echo e($campus, false); ?></option>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="roomno" id="roomno" value="<?php echo e(old('roomno', ''), false); ?>"/>
                <span class="help-block"><?php echo e('', false); ?></span>
            </div>
                </div>
            </div>
            ...
            <select name='homeroom_id' class="custom-select">
                <?php $__currentLoopData = $teachers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $teacher): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($id, false); ?>"><?php echo e($teacher, false); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
                    ...
                    <div class="form-group">
                        ...
                        <select name='template_id[]' class="custom-select select2" multiple data-maximum-selection-length="2">
                            <?php $__currentLoopData = $templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $template): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($id, false); ?>"><?php echo e($template, false); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /mnt/disk2/www/school/resources/views/admin/schoolClasses/create.blade.php ENDPATH**/ ?>