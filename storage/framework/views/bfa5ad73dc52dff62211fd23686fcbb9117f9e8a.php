                    ...
                    <div class="col-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="roomno" id="roomno"
                                value="<?php echo e(old('roomno', ''), false); ?>" />
                            <span class="help-block"><?php echo e('', false); ?></span>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wrok_in_ics\web_backend\resources\views/admin/schoolClasses/create.blade.php ENDPATH**/ ?>