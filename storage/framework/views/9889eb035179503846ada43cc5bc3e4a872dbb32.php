...
<div class="card">
    ...
    <h3 class="panel-title">Student Calling Dashboard - <span id="campus"></span></h3>
           ...
           <div class="col-2">
                 <h3 class="panel-title">Date: <?php echo e(date("d-M-Y"), false); ?></h3>
          </div>
...
<script>
    ...
    $(document).ready(function(){
        ...
        ajax: {
            url:"<?php echo e(route('admin.calling.getwaiting'), false); ?>?campus=" + selectCampus,
        ...
        columnDefs:[
            {
            'targets':[0, <?php echo e((request()->input('show_action')=='yes')?0:8, false); ?>],
            'visible':false,
            'searchable': false
            },
        ],
        ...
        function playsong(audio) {         
            ...
            var times = 3;
            var loop = setInterval(repeat, 1500);
