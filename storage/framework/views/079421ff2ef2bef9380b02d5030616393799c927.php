...
<body class="app header-fixed sidebar-fixed <?php echo e(request()->is('admin/timetable/create') || request()->is('admin/calling_dashboard/*') || request()->is('admin/createexamschedule') ? 'sidebar-minimized':'', false); ?>  aside-menu-fixed pace-done sidebar-lg-show">
    <header class="app-header navbar">
        ...
        <a class="navbar-brand" href="#">
            ...
            <span class="navbar-brand-minimized"><?php echo e(trans('panel.site_title'), false); ?></span>
        </a>
        ...
        <main class="main">
            ...
            <div style="padding-top: 20px" class="container-fluid">
                <?php if(session('message')): ?>
                    <div class="row mb-2">
                        <div class="col-lg-12">
                            <div class="alert alert-success" role="alert"><?php echo e(session('message'), false); ?></div>
                        </div>
                    </div>
                <?php endif; ?>
...
<?php /**PATH /mnt/disk3/www/school/resources/views/layouts/admin.blade.php ENDPATH**/ ?>