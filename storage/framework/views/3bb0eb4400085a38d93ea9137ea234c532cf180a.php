...
<div class="card">
    <div class="card-header">
        <form name="frmcampus" method="get" action="<?php echo e(route("admin.school-classes.index"), false); ?>" enctype="multipart/form-data">
        <div class="row">
        <div class="col">
                ...
                <tbody>
                    <?php $__currentLoopData = $schoolClasses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $schoolClass): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr data-entry-id="<?php echo e($schoolClass->id, false); ?>">
                            ...
                            <td>
                                <a href="<?php echo e(route('admin.timetable.create',['campus'=>$schoolClass->campus,'class_id'=>$schoolClass->id]), false); ?>">View Schedule</a>
                            </td>
                            <td>
                                

                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('school_class_edit')): ?>
                                    <a class="btn btn-xs btn-info" href="<?php echo e(route('admin.school-classes.edit', $schoolClass->id), false); ?>">
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('school_class_delete')): ?>
                                    <form action="<?php echo e(route('admin.school-classes.destroy', $schoolClass->id), false); ?>" method="POST" onsubmit="return confirm('<?php echo e(trans('global.areYouSure'), false); ?>');" style="display: inline-block;">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wrok_in_ics\2023_06_09-school\resources\views/admin/schoolClasses/index.blade.php ENDPATH**/ ?>