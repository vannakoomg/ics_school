                ...
                <br>
                    ...
                    <td style="vertical-align: top;text-align:center;padding-right:40px;">
                        ...
                        <div class="p-1 mb-4 bg-white" style="font-size:14px;background:#fff;width:90px;padding:5px;margin-top:15px;width:100%">
                            ...
                            <span class="float-right" style="float:right"><strong>School Year: <?php echo e((date('Y')) . '-' . (date('Y')+1), false); ?></strong></span>
                        </div>
                        <div>
...
<?php /**PATH /mnt/hdd/www/school/resources/views/admin/users/pdf-front.blade.php ENDPATH**/ ?>