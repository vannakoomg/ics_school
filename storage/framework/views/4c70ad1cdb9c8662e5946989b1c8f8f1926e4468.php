            ...
            <table class=" table table-bordered table-striped table-hover datatable datatable-SchoolClass">
                ...
                <tbody>
				 ...
				 <select name="txt_status[]" id="txt_status" class="select2">
                            ...
                            <td>
                                <input type="text" name="txt_remark[]" id="txt_remark" class="form-control" value="<?php echo e(old('txt_remark', $student->getRemark(date('Y-m-d')) ), false); ?>">
                            </td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/laravel/school/resources/views/admin/attendance/create.blade.php ENDPATH**/ ?>