        ...
        <form method="POST" enctype="multipart/form-data" id="upload_image_form" action="<?php echo e(route("admin.feedback.update",$feedback->id), false); ?>" >
            ...
            <div class="col-6">
                <div class="form-group">
                    ...
                    <span class="input-group-text">
                        <?php echo e($feedback->reply_by ?? Auth::user()->name, false); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/school/resources/views/admin/feedback/show.blade.php ENDPATH**/ ?>