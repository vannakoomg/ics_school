...
<div class="card">
    <div class="card-header">
        <?php echo e(trans('global.create'), false); ?> <?php echo e(request()->has('teacher')?'Teacher': (request()->has('student')?'Student': trans('cruds.user.title_singular')), false); ?>
    ...
    <div class="card-body">
        <form method="POST" action="<?php echo e(route("admin.users.store"), false); ?>" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="required" for="email"><?php echo e((!request()->has('student')?'Email':'Student ID'), false); ?></label>
                <input class="form-control <?php echo e($errors->has('email') ? 'is-invalid' : '', false); ?>" type="text" name="email" id="email" value="<?php echo e(old('email'), false); ?>" required>
            ...
            <input class="form-control <?php echo e($errors->has('email') ? 'is-invalid' : '', false); ?>" type="text" name="phone" id="phone" value="<?php echo e(old('phone'), false); ?>" required>
            ...
            <?php endif; ?>
                ...
                <div class="col-5">
                    <div class="form-group">
                        ...
                        <input class="form-control <?php echo e($errors->has('namekh') ? 'is-invalid' : '', false); ?>" type="text" name="namekh" id="namekh" value="<?php echo e(old('namekh'), false); ?>">
                    ...
                    <div class="row">
                        ...
                        <div class="col-8">
                            <div class="form-group">
                                ...
                                <input class="form-control <?php echo e($errors->has('rfidcard') ? 'is-invalid' : '', false); ?>" readonly type="text" name="rfidcard" id="rfidcard" value="<?php echo e(old('rfidcard'), false); ?>">
                        ...
                        <div class="col-4">
                            <div class="form-group text-nowrap align-bottom">
                                ...
                                <audio controls autoplay  style="height: 10px; width: 150px;position:inline;padding-top:10px;margin:0"></audio>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-2">
                    <div class="form-group">
                    <img src="<?php echo e(asset('storage/image/' . (request()->has('student') ? 'student-avatar.png' : 'teacher-avatar.png')), false); ?>" class="img-thumbnail btn btn-outline-primary" id="img_thumbnail" alt="select thumbnail" width="150px" height="150px">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2 <?php echo e($errors->has('class') ? 'is-invalid' : '', false); ?>" name="class_id[]" id="class_id" multiple>
                        <?php $__currentLoopData = $classes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($id, false); ?>" <?php echo e((in_array($id, old('class_id', [])))  ? 'selected' : '', false); ?>><?php echo e($class, false); ?></option>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2 <?php echo e($errors->has('class') ? 'is-invalid' : '', false); ?>" name="course_id[]" id="course_id" multiple>
                        <?php $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($id, false); ?>" <?php echo e((in_array($id, old('course_id', [])))  ? 'selected' : '', false); ?>><?php echo e($course, false); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 <?php echo e($errors->has('roles') ? 'is-invalid' : '', false); ?>" name="roles[]" id="roles" multiple required>
                    <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $roles): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($id, false); ?>" <?php echo e((in_array($id, old('roles', []))) ? 'selected' : '', false); ?>><?php echo e($roles, false); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 <?php echo e($errors->has('class') ? 'is-invalid' : '', false); ?>" name="class_id" id="class_id" required>
                    <?php $__currentLoopData = $classes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($id, false); ?>" <?php echo e(old('class_id') == $id ? 'selected' : '', false); ?>><?php echo e($class, false); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
                <?php if($errors->has('class')): ?>
                    <div class="invalid-feedback">
            ...
            <div class="row">
                <div class="col-2 text-center">
                    <div class="form-group">
                    <img src="<?php echo e(asset('storage/image/guardian-avatar.png'), false); ?>" class="img-thumbnail btn btn-outline-primary" id="collect_thumbnail1" alt="select thumbnail" width="150px" height="150px">
                    ...
                    <div class="form-group">    
                        <select name="guardian1" id="guardian1" class="form-select" >
                            <?php $__currentLoopData = $collection_guardian; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e(($item=='Select One Item')?'':$item, false); ?>" <?php echo e(old('guardian1') == $item ? 'selected' : '', false); ?>><?php echo e($item, false); ?> </option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                ...
                <div class="col-2 text-center">
                    <div class="form-group">
                    <img src="<?php echo e(asset('storage/image/guardian-avatar.png'), false); ?>" class="img-thumbnail btn btn-outline-primary" id="collect_thumbnail2" alt="select thumbnail" width="150px" height="150px">
                    ...
                    <div class="form-group">    
                        <select name="guardian2" id="guardian2" class="form-select" >
                            <?php $__currentLoopData = $collection_guardian; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e(($item=='Select One Item')?'':$item, false); ?>" <?php echo e(old('guardian2') == $item ? 'selected' : '', false); ?>><?php echo e($item, false); ?> </option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                </div>
                ...
                <div class="col-2 text-center">
                    <div class="form-group">
                    <img src="<?php echo e(asset('storage/image/guardian-avatar.png'), false); ?>" class="img-thumbnail btn btn-outline-primary" id="collect_thumbnail3" alt="select thumbnai" width="150px" height="150px">
                    ...
                    <div class="form-group">    
                        <select name="guardian3" id="guardian3" class="form-select" >
                            <?php $__currentLoopData = $collection_guardian; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e(($item=='Select One Item')?'':$item, false); ?>" <?php echo e(old('guardian3') == $item ? 'selected' : '', false); ?>><?php echo e($item, false); ?> </option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/laravel/school/resources/views/admin/users/create.blade.php ENDPATH**/ ?>