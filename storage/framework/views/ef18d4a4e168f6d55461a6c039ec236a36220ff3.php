                ...
                <div class="card-body text-center" style="background:rgb(219, 219, 252);padding-left:10px;padding-right:0px; width:15cm;height:10cm;">
                    ...
                    <div class="text-center float-right" style="width:11.2cm;padding-right:20px;padding-left:0px">
                        ...
                        <div class="p-1 mb-4 bg-white" style="font-size:14px;">
                            ...
                            <span class="float-right"><strong>School Year: <?php echo e((date('Y')) . '-' . (date('Y')+1), false); ?></strong></span>
                        </div>
...
<?php echo $__env->make((request()->print=="pdf")?'layouts.pdf':'layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /mnt/hdd/www/school/resources/views/admin/users/show.blade.php ENDPATH**/ ?>