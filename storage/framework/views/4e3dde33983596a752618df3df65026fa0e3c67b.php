                            ...
                            <td>
                                <div class="xzoom-thumbs text-left">
                                    <?php if(!empty($course->image)): ?>
                                        <img src="<?php echo e(asset('storage/image/' . $course->image), false); ?>" class="xzoom-gallery img-thumbnail btn btn-outline-primary" id="img_thumbnail" xpreview="<?php echo e(asset('storage/image' . $course->image), false); ?>" style="height: 100px !important">
                                    <?php else: ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wrok_in_ics\2023_06_09-school\resources\views/admin/course/index.blade.php ENDPATH**/ ?>