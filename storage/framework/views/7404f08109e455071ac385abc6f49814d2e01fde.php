            ...
            <div class="form-group">
                ...
                <select name="weekday" class="form-control <?php echo e($errors->has('weekday') ? 'is-invalid' : ''); ?>" id="weekday" required>
                    ...
                    <?php $__currentLoopData = $days; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($k); ?>" <?php echo e((($k==old('weekday'))?'selected':'')); ?>><?php echo e($day); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/icsapp/resources/views/admin/lessons/create.blade.php ENDPATH**/ ?>