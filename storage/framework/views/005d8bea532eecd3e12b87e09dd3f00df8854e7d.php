...
<div class="card">
    ...
    <form name="frmcampus" method="get" action="<?php echo e(route("admin.course.index"), false); ?>" enctype="multipart/form-data">
        ...
        <div class="col">
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                      <select  class="custom-select" name="filter_category" id="filter_category" onchange="document.forms['frmcampus'].submit()">
                          <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <option value="<?php echo e($category, false); ?>" <?php echo e(old('filter_category') == $category ? 'selected' : '', false); ?> <?php echo e($category==$current_filter['category']?'selected':'', false); ?>><?php echo e($category, false); ?></option>
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-sm table-bordered datatable datatable-SchoolClass">
                <thead>
                    <tr>
                        <th width="10">
...
-->
                            <td>
                                <div class="text-left" style="padding:0">
                                    <?php if(!empty($course->image)): ?>
                                        <img src="<?php echo e(asset('storage/image/' . $course->image), false); ?>" class="btn btn-outline-primary" id="img_thumbnail" xpreview="<?php echo e(asset('storage/image' . $course->image), false); ?>" style="height: 100px !important;padding:0px;margin:0">
                                    <?php else: ?>
                            ...
                            <td>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('course')): ?>
                                    ...
                                    <form action="<?php echo e(route('admin.course.destroy', $course->id), false); ?>" method="POST" onsubmit="return confirm('<?php echo e(trans('global.areYouSure'), false); ?>');" style="display: inline-block;">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /mnt/hdd/www/school/resources/views/admin/course/index.blade.php ENDPATH**/ ?>