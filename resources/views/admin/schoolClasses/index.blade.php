...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <form name="frmcampus" method="get" action="{{ route('admin.school-classes.index') }}"
                                ...
                                <select class="custom-select {{ $errors->has('campus') ? 'is-invalid' : '' }}"
                                    ...
                                    @foreach ($campus as $id => $key)
                                        <option value="{{ $key }}" {{ old('campus') == $key ? 'selected' : '' }}
                                            {{ $key == $current_filter['campus'] ? 'selected' : '' }}>{{ $key }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                    ...
                    <tbody>
                        @foreach ($schoolClasses as $key => $schoolClass)
                            <tr data-entry-id="{{ $schoolClass->id }}">
                                ...
                                <td>
                                    <a
                                        href="{{ route('admin.timetable.create', ['campus' => $schoolClass->campus, 'class_id' => $schoolClass->id]) }}">View
                                        Schedule</a>
                                </td>
                                <td>
