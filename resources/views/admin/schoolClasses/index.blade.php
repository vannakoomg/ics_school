...
<div class="card">
    <div class="card-header">
        <form name="frmcampus" method="get" action="{{ route("admin.school-classes.index") }}" enctype="multipart/form-data">
        <div class="row">
        <div class="col">
                ...
                <tbody>
                    @foreach($schoolClasses as $key => $schoolClass)
                        <tr data-entry-id="{{ $schoolClass->id }}">
                            ...
                            <td>
                                {{ $schoolClass->level_type ?? '' }}
                            </td>
                            <td>
                                @foreach ($schoolClass->schedule_template as $item)
                                    <span class="badge badge-info">{{ $item->name }}</span>
                                @endforeach
                            </td>
                            <td>
                                <a href="{{ route('admin.timetable.create',['campus'=>$schoolClass->campus,'class_id'=>$schoolClass->id]) }}">View Schedule</a>
                            </td>
                            <td>
