...
<div class="card">
    ...
    <form name="frmcampus" method="get" action="{{ route("admin.homework.completed") }}" enctype="multipart/form-data">
        <div class="row">
        <div class="col">
            <h3>Completed {{ trans('global.list') }}</h3>
        </div>
...
<script>
   ...
   // $.fn.dataTable.ext.errMode = 'none';
       ...
       // "deferLoading": 0,
        ajax: {
            'dataType':'json',
            url:"{{ route('admin.homework.ajaxhomework') }}?completed=1",
