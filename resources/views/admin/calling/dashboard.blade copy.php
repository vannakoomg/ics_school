                ...
                <div class="btn-group" role="group">
                    ...
                    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                        ...
                        @if(request('category')!=3)
                            <a class="dropdown-item" href="{{ route("admin.calling.dashboard",['MC','3']) }}{{ request()->length ? '?length=0' : '' }}">Monitoring</a>
                        @endif
                    </div>
                  </div>
...
<script>
    ...
    $(document).ready(function(){
        ...
        bInfo:false,
        ajax: {
            url:"{{ route('admin.calling.getwaiting') }}?campus=" + selectCampus + '&category={{ request("category") }}&startrow=' + (startrow + lengthrow ) + '&lengthrow=' + lengthrow,
        ...
        bInfo:false,
        ajax: {
            url:"{{ route('admin.calling.getwaiting') }}?campus=" + selectCampus + '&category={{ request("category") }}&startrow=' + (startrow + (lengthrow * 2) ) + '&lengthrow=' + lengthrow,
        ...
        bInfo:false,
        ajax: {
            url:"{{ route('admin.calling.getwaiting') }}?campus=" + selectCampus + '&category={{ request("category") }}&startrow=' + (startrow + (lengthrow * 3) ) + '&lengthrow=' + lengthrow,
        ...
        getAllWaiting = function(){
            $.ajax({
                type:'get',
                url: "{{ route('admin.calling.getwaitingvoice') }}?campus=" + selectCampus + '&category={{ request("category") }}&startrow=0&lengthrow=' + (lengthrow*4),
                data: {},
                cache:false,
                dataType: 'json',
                // contentType: false,
